...
function render(){
    ...
    if(!data.length){h='<tr><td colspan="9" style="text-align:center;padding:40px;color:#94a3b8;">No hay empresas</td></tr>';}
        ...
        data.forEach((c,i)=>{
            ...
            h+='<div class="dropdown"><button class="btn btn-sm" style="background:#f1f5f9;border:none;padding:8px 14px;border-radius:8px;font-size:12px;font-weight:600;color:#475569;" data-toggle="dropdown">Acciones <i class="fa fa-chevron-down ml-1" style="font-size:9px;"></i></button>';
